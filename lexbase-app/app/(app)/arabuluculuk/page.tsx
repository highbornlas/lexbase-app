      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          ...
          <div className="text-xs text-text-dim/60">
            {arama || durumFiltre !== 'hepsi' ? 'Farklı filtreler deneyebilirsiniz' : 'Yeni bir arabuluculuk dosyası ekleyerek başlayın'}
          </div>
        </div>
      ) : (
        <div className="bg-surface border border-border rounded-lg overflow-hidden flex-1 overflow-x-auto">
          ...
          <div className={`grid ${GRID} gap-2 px-4 py-2.5 border-b border-border text-[11px] text-text-muted font-medium uppercase tracking-wider min-w-[980px] sticky top-0 z-10 bg-surface`}>
